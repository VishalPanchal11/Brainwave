      ...
      <div className="container ">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] p-8 mb-5 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border border-n-1/10 lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2 lg:w-[40rem] md:left-1/2 md:right-auto md:bottom-8 md:-translate-x-1/2 md:w-[40rem]" />
          </div>
